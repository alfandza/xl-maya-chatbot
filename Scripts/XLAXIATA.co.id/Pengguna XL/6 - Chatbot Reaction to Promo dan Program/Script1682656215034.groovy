...
WebUI.click(findTestObject('Chatbot xlaxiata.com/Promo dan Program/button XL Prepaid'))
...
WebUI.click(findTestObject('Chatbot xlaxiata.com/Promo dan Program/button XL prioritas'))
...
WebUI.click(findTestObject('Chatbot xlaxiata.com/Promo dan Program/button XL Home'))
...
WebUI.comment('XL Satu')

WebUI.click(findTestObject('Chatbot xlaxiata.com/Promo dan Program/button XL Satu'))
...
WebUI.click(findTestObject('Chatbot xlaxiata.com/Promo dan Program/button Axis'))
